"""
Real experimental data tracker that streams flight_positions.npy data.
Simple streaming of real experimental bat flight data.
"""
import time
import threading
import numpy as np
...
class RealDataTracker:
    """Streams real experimental data from flight_positions.npy at correct frame rate"""
    ...
    def _load_flight_data(self, rtls_config: Dict[str, Any]):
        ...
        try:
            ...
            raise Exception(f"Could not load real experimental data: {e}")
    ...
    def _stream_loop(self):
        """Main streaming loop - simply stream the real experimental data"""
        frame_interval = 1.0 / self.frame_rate
        
        print("Real data streaming started")
        ...
        while self.running:
            ...
            try:
                ...
                print(f"Error in real data streaming: {e}")
                time.sleep(0.1)
        
        print("Real data streaming stopped")
